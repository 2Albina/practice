...
| **gcc**           | **Время пересборки без предкомп. хедера**     | 1.005          | 2.369            | 4.105             |
|                   | **Время пересборки с предкомп. хедером**      | 1.553          | 2.357            | 3.519             |
|                   | **Изменение времени пересборки**              | +55%           | -1%              | -14%              |
...
Причем на msvc эффект более заметен, чем на gcc, clang.
